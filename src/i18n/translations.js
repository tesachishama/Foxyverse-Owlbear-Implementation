...
export const translations = {
  en: {
    ...
    chatApplyPhysicalDamage: "{{name}} took {{actual}} physical damage [{{raw}} - {{def}} PD]",
    chatApplyMagicalDamage: "{{name}} took {{actual}} magical damage [{{raw}} - {{def}} MD]",
    chatApplyTrueDamage: "{{name}} took {{actual}} true damage",
    gainedVerb: "gained",
