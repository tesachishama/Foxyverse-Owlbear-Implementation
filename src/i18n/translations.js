...
export const translations = {
  en: {
    ...
    chatApplyMagicalDamageElemental: "{{name}} took {{total}} magical damage (elemental) [2×{{raw}} − {{def}} MD]; mana lost: {{manaLost}}.",
    chatApplyTrueDamage: "{{name}} took {{actual}} true damages",
    chatApplyTrueDamageToMana: "{{name}} lost {{actual}} mana from true damage",
    chatApplyTrueDamageElemental: "{{name}} took {{total}} true damage (elemental); mana lost: {{manaLost}}.",
  ...
  fr: {
    ...
    chatApplyMagicalDamageElemental: "{{name}} a pris {{total}} dégâts magiques (élémentaire) [2×{{raw}} − {{def}} MD] ; mana perdue : {{manaLost}}.",
    ...
    chatApplyTrueDamageElemental: "{{name}} a pris {{total}} dégâts bruts (élémentaire) ; mana perdue : {{manaLost}}.",
    chatCurrencyGift: "{{fromName}} {{gave}} {{gold}} {{goldLabel}}, {{silver}} {{silverLabel}}, {{copper}} {{copperLabel}} {{to}} {{toName}}",
    chatItemGift: "{{fromName}} {{gave}} {{qty}} × {{itemName}} {{to}} {{toName}}",
    gainedVerb: "a gagné",
